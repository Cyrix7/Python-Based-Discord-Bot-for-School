...
async def hello(ctx):
    response = ['***grumble***', 'Why did you wake me up?', 'Top of the morning to you lad!',
                'Hello {}'.format(
                    ctx.author.mention) + ' how are you?', 'Hi {} '.format(ctx.author.mention),
                '**Wassup!** {}'.format(ctx.author.mention)]
